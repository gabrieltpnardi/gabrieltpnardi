...
function setup() {
  ...
  setTimeout(fake1B,8000);
  setTimeout(fake2, 12000);
  setTimeout(fake2B,13000);
  setTimeout(fake3,15000);
  setTimeout(fake3B,16000);
  setTimeout(fake4,18000);
  setTimeout(fake4B,20000);
